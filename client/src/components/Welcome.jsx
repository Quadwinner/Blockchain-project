...
import { Loader } from ".";
import { generateQRCodeValue } from "../utils/generateQRCodeValue"; // Import the function to generate QR code value
...
const Welcome = () => {
  ...
  // Update QR code value when the amount changes
  const handleAmountChange = (e, name) => {
    handleChange(e, name);
    const { addressTo, amount, keyword, message } = formData;
    setQRValue(generateQRCodeValue(amount)); // Update QR code value
  };
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            <Input placeholder="Amount (ETH)" name="amount" type="number" value={formData.amount} handleChange={handleAmountChange} />
